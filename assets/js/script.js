...
function runGame(gameType) {
    ...
    if (gameType === "addition") {
        ...
        displaySubtrationQuestion(num1, num2)
    }else
        {
...
/**
 * Checks the answer against the first elemenet 
...
/**
 * Gets incorrect score from the DOM and increments it by 1
 */
...
function displaySubtrationQuestion(operand1, operand2) {
